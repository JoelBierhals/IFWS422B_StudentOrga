...
public class AccountCtr {
    public static void main(String[] args) throws Exception {
        ...
        // Press CTRL + ALT
        SavingsAccount sb1 = new SavingsAccount("Iris Hanheide");
        ...
        CheckingAccount g1 = new CheckingAccount("Iris Hanheide");
        System.out.println(g1.toString());
        // System.out.println("Check Iban: " + Account.checkIban(g1.getIban()) + "\n");

        CheckingAccount g2 = new CheckingAccount("Udo Lindenberg");
